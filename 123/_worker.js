...
let Pswd = 'Aa2980688';
const proxyIPs = ["cdn-all.xn--b6gac.eu.org"]; //workers.cloudflare.cyou bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org
let hostnames = ['fbi.gov'];
